...
class NorfairTracker(ObjectTracker):
    ...
    def update_position(
        ...
        avg_box = average_boxes(self.stationary_box_history[id])  # type: ignore[arg-type]
        avg_iou = intersection_over_union(box, avg_box)
        median_box = median_of_boxes(self.stationary_box_history[id])  # type: ignore[arg-type]
